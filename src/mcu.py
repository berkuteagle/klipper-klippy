...
class MCU_trsync:
    ...
    def _build_config(self):
        ...
        self._trdispatch_mcu = chelper.trdispatch_mcu_alloc(
    ...
    def start(self, print_time, trigger_completion, expire_timeout):
        ...
        chelper.trdispatch_mcu_setup(self._trdispatch_mcu, clock, expire_clock,
...
class MCU_endstop:
    ...
    def __init__(self, mcu, pin_params):
        ...
        self._trigger_completion = None
        self._rest_ticks = 0
        self._trdispatch = chelper.trdispatch_alloc()
    ...
    def home_start(self, print_time, sample_time, sample_count, rest_time,
        ...
        chelper.trdispatch_start(self._trdispatch, etrsync.REASON_HOST_REQUEST)
        self._home_cmd.send(
    ...
    def home_wait(self, home_end_time):
        ...
        chelper.trdispatch_stop(self._trdispatch)
...
class MCU:
    ...
    def _connect(self):
        ...
        self._steppersync = chelper.steppersync_alloc(self._serial.get_serialqueue(),
    ...
    def flush_moves(self, print_time):
        ...
        if clock < 0:
            return
        ret = chelper.steppersync_flush(self._steppersync, clock)
        if ret:
