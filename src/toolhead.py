...
from . import chelper, kinematics
...
class ToolHead:
    ...
    def _update_move_time(self, next_print_time):
        ...
        while 1:
            ...
            chelper.trapq_finalize_moves(self.trapq, free_time)
    ...
    def drip_move(self, newpos, speed, drip_completion):
        ...
        try:
            ...
            chelper.trapq_finalize_moves(self.trapq, self.reactor.NEVER)
        # Exit "Drip" state
        self.flush_step_generation()
    # Misc commands
