...
class ExtruderStepper:
    def __init__(self, config):
        ...
        self.sk_extruder = ffi.gc(lib.extruder_stepper_alloc(),
                                  lib.free)
    ...
    def _set_pressure_advance(self, pressure_advance, smooth_time):
        ...
        espa = lib.extruder_set_pressure_advance
...
class PrinterExtruder:
    def __init__(self, config, extruder_num):
        ...
        self.trapq = ffi.gc(lib.trapq_alloc(), lib.trapq_free)
        self.trapq_append = lib.trapq_append
        self.trapq_finalize_moves = lib.trapq_finalize_moves
